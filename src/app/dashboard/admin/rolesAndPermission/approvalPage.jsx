...
const data = await updateArts(id, {
  status: "approved",
});
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <thead className="bg-slate-50 border-b">
                <tr>
                  <th className="text-left p-5 text-xs uppercase text-slate-500">
                    Artwork
                  </th>
                  ...
                  <th className="text-center p-5 text-xs uppercase text-slate-500">
                    Actions
                  </th>
                </tr>
              </thead>
